...
def draw_window(red, yellow, random, red_bullets, yellow_bullets, red_health, yellow_health):
    WIN.blit(SPACE,(0,0))
...
def main():
    ...
    while run:
        ...
        draw_window(red,yellow,random, red_bullets, yellow_bullets, red_health, yellow_health)
